...
<body>
  ...
  <form onsubmit="return false;" class="form container">
    <div class="row no-gutters">
      <div class="col-xs-12">
        <h1><a href="javascript:(function(){m='https://condensr.io/?LongformURL='+encodeURIComponent(document.location);w=window.open(m);})();" class="btn btn-outline-success">Condensr</a> (&lt;&lt;= This is a bookmarklet! Try it on an article.)</h1>
