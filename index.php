...
<body>
  ...
  <form onsubmit="return false;" class="form container">
    <div class="row no-gutters">
      <div class="col-xs-12">
        <p><a href="javascript:(function(){m='https://condensr.io/?LongformURL='+encodeURIComponent(document.location);w=window.open(m);})();" class="btn btn-outline-success"><h1>Condensr</h1></a> (&lt;&lt;= This is a bookmarklet! Try it on an article.)</p>
